...
if "%route1_2_birdsong%" == "heard" goto tile_route1_2_continued
set route1_2_birdsong=heard
echo      ^> A calm and inspiring bird song echoes through the peaceful forest.
echo      ^> You gain 10 exp.
set /a exp=%exp% + 10
goto checklevelup
goto returnLocation
)
if %randomeventchance% GTR 89 (
if "%route1_2_ruinedcap%" == "absent" goto tile_route1_2_continued
echo      ^> A bird nest on the ground draws your attention.
...
echo      ^> He used to wear a gold medal bestowed up on him by the villagers.
echo.
echo    [What do you do?]
echo      1. investigate the body
echo      2. loot the body
echo      3. say a prayer
...
echo      ^> Perhaps it has imparted some of its wisdom.
echo      ^> You gain 20 exp.
set /a exp=%exp% + 20
