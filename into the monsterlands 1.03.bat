...
echo      ^> You gain %enemymaxHP% exp.
echo.
echo    [You take a greenish potion and the goblin's little staff.]
echo      ^> ^+1 antidote
echo      ^> ^+1 goblin staff
echo      ^> "i" to open inventory
set confusion=no
...
echo      ^> ^+1 leather hood, ^+1 ruined tunic, ^+57 goblin scimitars
echo      ^> "i" to open inventory
set /a luck=%luck% + 3
...
pause >nul
echo.
echo    [You turn away from the body, into an ambush.]
